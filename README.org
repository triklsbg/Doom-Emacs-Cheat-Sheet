...
- =SPC= - "Space" key
* Modal Editing
- =ESC= brings from insert Mode to Normal Mode. Cursor shape is a letter wide block. The indicator in the status line is =N=. The keys you enter are interpreted as commands.
